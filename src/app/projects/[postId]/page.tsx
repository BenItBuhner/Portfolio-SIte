      ...
      <main className="page-main">
        <section className={styles.page}>
          <div className="header-wrapper">
            ...
            {project && !project.comingSoon && <p className="header-subtitle">Project details</p>}
          </div>
          ...
          {project ? (
            project.comingSoon ? (
              <div className={styles.comingSoonMessage}>
                ...
                <h2>Coming Soon</h2>
                <p>This project is currently in development and will be available soon. Check back later!</p>
              </div>
            ) : (
              <>
