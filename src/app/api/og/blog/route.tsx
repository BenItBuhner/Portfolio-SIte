...
export async function GET(request: Request) {
  ...
  // If blog not found or no header image, use fallback (page-style) design
  if (!blog || !blog.image) {
  ...
  const headerImageSrc = getImageSrc(blog.image);
...
/**
 * Fallback image when blog has no header image.
